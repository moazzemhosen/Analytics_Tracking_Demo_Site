...
const Card = () => {
    const cards = [
        ...
        { "Name": "Reports & Dashboard", "Details": "A summary of findings, analysis of data trends, recommendations for action, and an open forum for team feedback and collaboration.", "link": "/analytics" },
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 p-4 sm:p-10 md:p-16 lg:p-20">
            {cards.map((card, idx) => (
